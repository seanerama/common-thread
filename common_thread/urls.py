...
urlpatterns = [
    ...
    path("interactions/new/", views.interaction_new),
    path("interactions/<str:interaction_id>/", views.interaction_detail),
    path("interactions/<str:interaction_id>/edit/", views.interaction_edit),
    path("interactions/<str:interaction_id>/history/", views.interaction_history),
    path("commitments/", views.commitment_list),
    path("commitments/new/", views.commitment_new),
    path("commitments/<str:commitment_id>/", views.commitment_detail),
    path("commitments/<str:commitment_id>/edit/", views.commitment_edit),
    path(
        "commitments/<str:commitment_id>/complete/",
        views.commitment_state,
        {"completed": True},
    ),
    path(
        "commitments/<str:commitment_id>/reopen/",
        views.commitment_state,
        {"completed": False},
    ),
